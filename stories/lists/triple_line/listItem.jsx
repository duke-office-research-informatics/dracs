...
stories.add(
  ...
  withInfo(`
    ...
    The double line list item passes the main area as the \`lineOne\`, \`lineTwo\`, and \`lineThree\` props.

     #### Example Declaration
     ~~~js
     import { List, TripleLineListItem } from 'dracs';
     ~~~
     #### Example usage:
     ~~~js
        ...
        {listData.map(item => {
          return (
            <TripleLineListItem
              ...
              lineThree={item.description}
              lineThreeStyle={object('lineThreeStyle', {})}
