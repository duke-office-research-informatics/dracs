...
import { withKnobs, number, text, boolean, select, object, color } from '@storybook/addon-knobs/react';
import { withInfo } from '@storybook/addon-info';
import { Stepper, Step, StepLabel, IconWarning, IconSearch, IconHelp, IconDownloadFile, theme } from '../../src/index.js';
...
stories.add(
  ...
  `)(() => {
    ...
    const iconCompleteColor = color('iconCompleteColor', theme.colors.action);
    const iconIncompleteColor = color('iconIncompleteColor', theme.colors.muted);
