...
import { H4, H5, P } from "../typography/typography.js";
...
const TripleLineListItem = props => {
  const handleKeyUp = e => {
    if (props.onClick) {
    ...
    >
      <ItemLeftContainer>
        ...
        <TextContainer>
          ...
          <LineThree style={props.lineThreeStyle}>{props.lineThree}</LineThree>
        </TextContainer>
      </ItemLeftContainer>
...
TripleLineListItem.propTypes = {
  ...
  /** String or react element that displays as the third line in the item */
  lineThree: propTypes.oneOfType([propTypes.string, propTypes.node]),
  /** Style object for the text/element passed into line three */
  lineThreeStyle: propTypes.object,
...
export default TripleLineListItem;
